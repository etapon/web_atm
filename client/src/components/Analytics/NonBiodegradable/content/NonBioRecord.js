...
const NonBioRecord = ({nonBioSorted}) => {
    ...
    if(nonBioSorted != null){
        nonBioSorted.forEach(populateLabel)

        function populateLabel(item){
        chartLabels.push(item._id)
        }

        nonBioSorted.forEach(populateData)
            ...
            <Paper style={{ padding: '10px', borderRadius: '15px' }} elevation={6}>
                <div className={classes.card}>
                    <div className={classes.section}>
                        <center>
                            <Typography variant="h6" component="h6">non-Biodegradable Records</Typography>
