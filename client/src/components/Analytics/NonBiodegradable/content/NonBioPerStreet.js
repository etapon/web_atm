...
const NonBioPerStreet = () => {
    ...
    if(nonBiodegradableDynamic != null){
        nonBiodegradableDynamic.forEach(populateLabel)

        function populateLabel(item){
        chartLabels.push(item._id)
        }

        nonBiodegradableDynamic.forEach(populateData)
...
export default NonBioPerStreet