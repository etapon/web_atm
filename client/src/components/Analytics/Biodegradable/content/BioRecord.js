...
const BioRecord = ({bioSorted}) => {
    ...
    if(bioSorted != null){
        bioSorted.forEach(populateLabel)

        function populateLabel(item){
        chartLabels.push(item._id)
        }

        bioSorted.forEach(populateData)
            ...
            <Paper style={{ padding: '10px', borderRadius: '15px' }} elevation={6}>
                <div className={classes.card}>
                    <div className={classes.section}>
                        <center>
                            <Typography variant="h6" component="h6">Biodegradable Records</Typography>
