...
const BioThisMonth = ({bioCountThisMonth}) => {
                ...
                <div className={classes.card}>
                    <div className={classes.section}>
                        <center>
                            ...
                            <Typography variant='h4'> <strong>{bioCountThisMonth? (bioCountThisMonth): "0"}</strong> kg</Typography>
                        </center>
                    </div>
                </div>
            </Paper>
